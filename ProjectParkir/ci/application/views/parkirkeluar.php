                ...
                <div class="card card-info">
                  ...
                  <form action="<?php echo base_url('keluar/kendaraankeluar') ?>" method="post">
                      ...
                      <div class="form-group hidden">
                        ...
                        <div class="input-group">
                          <div class="input-group-prepend">
                            ...
                            <input type="text" class="form-control" id="" placeholder="Kode Barcode" name="karcis">
                          </div>
                        </div>
                    ...
                    <div class="card-footer">
                      <button type="submit" class="btn btn-primary pull-right">Cek Barcode</button>
                    </div>
                  </form>
                </div>
                <!-- /.card -->
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <?php foreach ($keluar as $row) { ?>
                      <tr>
                        ...
                        <td><a href="<?php echo base_url('keluar/'.$row['kd_keluar']) ?>"></a><a href="<?php echo base_url('masuk/delete/'.$row['kd_masuk']) ?>"><i class="fa fa-trash"></i></a></td>
                      </tr>
                    <?php } ?>
                    </tfoot>
                    </table>
