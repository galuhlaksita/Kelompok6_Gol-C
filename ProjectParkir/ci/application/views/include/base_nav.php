...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?php echo base_url('home') ?>" class="brand-link">
      <img src="<?php echo base_url('assets') ?>/dist/img/Polije.png"
           alt="Parkir"
           class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light"><h6>Millenial Parking System</h6></span>
    </a>
